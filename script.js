...
var userInfo = [{username:"001",password:"ajarnjack",role:"Admin",name:"AjarnJack",lastname:"How to understand"},
                {username:"641",password:"001",role:"Student",name:"Nutchapon",lastname:"Kittingam"},
                {username:"641",password:"002",role:"Student",name:"Karnpitcha",lastname:"Hongegg"},
                {username:"641",password:"003",role:"Student",name:"Punyanuch",lastname:"Patcharapongpan"},
                {username:"641",password:"004",role:"Student",name:"Peerapat",lastname:"Suttiprasit"},
                {username:"641",password:"005",role:"Student",name:"Mallika",lastname:"Thammajit"}];
